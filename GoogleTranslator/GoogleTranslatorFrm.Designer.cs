namespace RavSoft.GoogleTranslator
{
    partial class GoogleTranslatorFrm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.referenceTextUrl = new System.Windows.Forms.TextBox();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			// _editSourceText
			// 
			this._editSourceText.AcceptsReturn = true;
			this._editSourceText.AcceptsTab = true;
			this._editSourceText.AllowDrop = true;
			...
			this._editSourceText.Location = new System.Drawing.Point(8, 111);
			this._editSourceText.MaxLength = 80000;
			...
			this._editSourceText.Size = new System.Drawing.Size(339, 99);
			...
			this.label3.Text = "Source tex URL:";
			// 
			// label4
			// 
			...
			// _editTarget
			// 
			this._editTarget.AcceptsReturn = true;
			this._editTarget.AcceptsTab = true;
			this._editTarget.AllowDrop = true;
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this._editTarget.BackColor = System.Drawing.SystemColors.ButtonHighlight;
			this._editTarget.Location = new System.Drawing.Point(8, 68);
			...
			this._editTarget.Size = new System.Drawing.Size(198, 24);
			this._editTarget.TabIndex = 10;
			this._editTarget.Text = "Translated.txt";
			// 
			// _btnTranslate
			// 
			...
			this._btnTranslate.Location = new System.Drawing.Point(272, 216);
			...
			this._lnkReverse.Location = new System.Drawing.Point(362, 111);
			this._lnkReverse.Name = "_lnkReverse";
			this._lnkReverse.Size = new System.Drawing.Size(32, 13);
			this._lnkReverse.TabIndex = 7;
			this._lnkReverse.TabStop = true;
			this._lnkReverse.Text = "Clear";
			...
			this._btnSpeak.Location = new System.Drawing.Point(352, 216);
			...
			this._lnkSourceEnglish.Size = new System.Drawing.Size(53, 13);
			this._lnkSourceEnglish.TabIndex = 2;
			this._lnkSourceEnglish.TabStop = true;
			this._lnkSourceEnglish.Text = "Japanese";
			...
			this.label5.Text = "Reference Text:";
			// 
			// referenceTextUrl
			// 
			this.referenceTextUrl.Location = new System.Drawing.Point(212, 68);
			this.referenceTextUrl.Name = "referenceTextUrl";
			this.referenceTextUrl.Size = new System.Drawing.Size(159, 21);
			this.referenceTextUrl.TabIndex = 16;
			this.referenceTextUrl.Text = "Ref.txt";
			// 
			// GoogleTranslatorFrm
			// 
			...
			this.Controls.Add(this.referenceTextUrl);
		...
		private System.Windows.Forms.TextBox referenceTextUrl;
    }
}